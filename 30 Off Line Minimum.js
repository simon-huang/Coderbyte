...
function OffLineMinimum(strArr) {
    ...
    for (var i = 0; i < strArr.length; i++){
        strArr[i] != "E" ? current.push(strArr[i]) : whenE(current);
    }
    return removed.join(",");
}

console.log(OffLineMinimum(["4","6","E","1","7","E","E","3","2"]));

// another way to get the smallest number in an array (and move it to another)
